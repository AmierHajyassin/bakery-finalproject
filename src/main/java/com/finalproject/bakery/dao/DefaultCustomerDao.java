...
public class DefaultCustomerDao implements CustomerDao{
  ...
  public Optional<Customer> createCustomer(String customer_namePK, String customer_phoneNum, String customer_email) {
    
    log.info("DAO: customer_name={}, customer_phoneNum={}, customer_email", customer_namePK, customer_phoneNum, customer_email);
    ...
    return Optional.ofNullable(Customer
        .builder().customer_namePK(customer_namePK)
  ...
  public Optional<Customer> updateCustomer(String customer_name, String customer_phoneNum,  String customer_email,
    ...
    log.info("DAO: customer_namePK={}, customer_phoneNum={}, customer_email={}, "
        + "newcustomer_namePK={}, newcustomer_phoneNum={}, newcustomer_email={}", customer_name, customer_phoneNum, customer_email,
    ...
    return Optional.ofNullable(Customer
        .builder()
        .customer_namePK(newcustomer_name)
        .customer_phoneNum(newcustomer_phoneNum)
        .customer_email(newcustomer_email)
        .build()
        ); 
  ...
  @Override
 public Optional<Customer> deleteCustomer(String customer_namePK, String customer_phoneNum, String customer_email) {
     //@formatter:off
    ...
    return Optional.ofNullable(Customer.builder()
        .customer_namePK(customer_namePK)
        .customer_phoneNum(customer_phoneNum)
        .customer_email(customer_email)
        .build());
    }
